...
Drop your background videos in this folder. The site picks them up automatically.

- Supported formats: `.mp4`, `.webm`, `.mov`, `.m4v`, `.ogv`
- Add as many as you like. They play one after another and loop back to the first.
